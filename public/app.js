...
/* harmony import */ var _modules_searchJoke__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/searchJoke */ "./src/modules/searchJoke.js");


(0,_modules_renderForm__WEBPACK_IMPORTED_MODULE_0__["default"])();
(0,_modules_searchJoke__WEBPACK_IMPORTED_MODULE_1__["default"])();
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
var createText = function createText(response) {
  var elementText = document.createElement('div');
  elementText.className = 'text-justify';
  elementText.innerHTML += "<p>".concat(response.value, "</p>");
...
var form = function form() {
  return "<div class=form-group-mb-2>\n<input lang=\"lt\" type=\"text\" class=\"form-control term\" placeholder=\"What about joke you would like?\">\n</div>\n<div class=\"form-group-mb-2\">\n<button type=\"submit\" class=\"btn btn-primary\">Search</button>\n</div>\n";
};
...
var renderForm = function renderForm() {
  ...
  element.innerHTML = (0,_form__WEBPACK_IMPORTED_MODULE_0__["default"])();
...
/* harmony import */ var _createText__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./createText */ "./src/modules/createText.js");



var searchJoke = function searchJoke() {
  document.querySelector('form').addEventListener('submit', function (e) {
    ...
    (0,_ajaxService__WEBPACK_IMPORTED_MODULE_0__["default"])(searchTerm).then(function (result) {
      ...
      if (searchResponse.total > 0) {
        ...
        searchResponse.result.forEach(function (res) {
          document.querySelector('main .result').appendChild((0,_createText__WEBPACK_IMPORTED_MODULE_1__["default"])(res));
        });
      } else {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (searchJoke);
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkchuck"] = self["webpackChunkchuck"] || [];
